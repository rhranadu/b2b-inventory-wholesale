...
/******/ 	return __webpack_require__(__webpack_require__.s = "../demo1/src/js/pages/custom/user/list-datatable.js");
/******/ })
/************************************************************************/
/******/ ({
			...
			columns: [
				{
					...
					template: function(data) {
						...
						if (number > 8) {
							output = '<div class="d-flex align-items-center">\
								...
								<div class="ml-4">\
									<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + data.VendorAgent + '</div>\
									<a href="#" class="text-muted font-weight-bold text-hover-primary">' + data.VendorEmail + '</a>\
								</div>\
							</div>';
						}
						else {
							...
							output = '<div class="d-flex align-items-center">\
								<div class="symbol symbol-40 symbol-light-'+state+' flex-shrink-0">\
									<span class="symbol-label font-size-h4 font-weight-bold">' + data.VendorAgent.substring(0, 1) + '</span>\
								</div>\
								<div class="ml-4">\
									<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + data.VendorAgent + '</div>\
									<a href="#" class="text-muted font-weight-bold text-hover-primary">' + data.VendorEmail + '</a>\
					...
					template: function(row) {
						...
						output += '<div class="font-weight-bold text-muted">' + row.VendorName + '</div>';
