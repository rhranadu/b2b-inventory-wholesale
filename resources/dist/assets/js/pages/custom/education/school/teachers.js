...
/******/ 	return __webpack_require__(__webpack_require__.s = "../demo1/src/js/pages/custom/education/school/teachers.js");
/******/ })
/************************************************************************/
/******/ ({
			...
			columns: [
				 {
					...
					template: function(data) {
						...
						output = '<div class="d-flex align-items-center">\
							...
							<div class="ml-4">\
								<a href="#" class="text-dark-75 text-hover-primary font-weight-bolder font-size-lg mb-0">' + data.VendorAgent + '</a>\
					...
					template: function(row) {
						...
						output += '<a href="#" class="text-dark-50 text-hover-primary font-weight-bold">' + row.VendorName + '</a>';
