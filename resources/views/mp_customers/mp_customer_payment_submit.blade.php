...
@section('title', 'Marketplace Customer Payment Add')
@push('css')
    <style>
        input[type=file]{
            /*width:90px;*/
            ...
            <div class="card card-custom min-h-500px" id="kt_card_1">
                <div class="card-body">
                    ...
                    <div class="normal-table-list">
                        <div class="bsc-tbl">
                            <form
                                method="POST" action="{{ route('admin.mp_customer_payment.store') }}" accept-charset="UTF-8"
                            ...
                            @csrf
                                <div class="form-element-list">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            <div class="form-group">
                                                <input type="hidden" value="{{$mp_customer->id}}" name="mp_customer_id">
...
@push('script')
    <script>
        ...
        $("#saleId").select2({
            ...
            allowClear: true,
            ajax: {
                url: "{{ url("admin/mp_customer-invoices/").'/'.$mp_customer->id.'?sale_id='.$sale_id }}",
                dataType: 'json',
                type: 'GET',
