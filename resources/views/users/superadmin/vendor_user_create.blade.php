            ...
            <div class="card-body">
                ...
                <div class="normal-table-list">
                    <div class="bsc-tbl">
                        ...
                        $roles = App\UserRole::where('user_type_id',2)->get();
                        @endphp

                        <form action="{{ route('superadmin.user.vendor.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <div class="form-group ic-cmp-int">
                                                    ...
                                                    <div class="nk-int-st">
                                                        <label for="email">Email<span style="color: red; font-size: 18px"><sup>*</sup></span>
                                                        </label>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <div class="form-group ic-cmp-int">
                                                    ...
                                                    <div class="nk-int-st">
                                                        <label for="mobile">Mobile<span style="color: red; font-size: 18px"><sup>*</sup></span>
                                                        </label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <div class="form-group ic-cmp-int">
                                                    ...
                                                    <div class="nk-int-st">
                                                        <label for="password">Password<span style="color: red; font-size: 18px"><sup>*</sup></span>
                                                        </label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <div class="form-group ic-cmp-int">
                                                    ...
                                                    <div class="nk-int-st">
                                                        <label for="vendor_id">Vendor <span style="color: red; font-size: 18px">*</span></label>
                                                        <select name="vendor_id" class="form-control"
                                                            data-live-search="true" required>
                                                            <option value="">Select Vendor </option>
                                                            @foreach($vendors as $vendor)
                                                            <option value="{{ $vendor->id }}" {{ old('vendor_id') ==  $vendor->id ? 'selected' : ''}}>{{ $vendor->name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                        @error('vendor_id')
                                                ...
                                                <div class="checkbox-inline">
                                                    <label class="checkbox checkbox-outline checkbox-success">
                                                        <input value="1" type="checkbox" id="addedItemCheckbox" name="status"
                                                               class="i-checks" {{ old('status') == 1 ? 'checked' : '' }}>
                                                        <span></span>
                                                        Status
                                                    </label>
                                                </div>
