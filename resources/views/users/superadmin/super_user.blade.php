    ...
    <div class="card card-custom min-h-500px" id="kt_card_1">
        <div class="card-body">
            <div class="table-responsive">
                <table id="superUserDataTable" class="table table-striped superUserDataTable">
                    <thead>
                    <tr>
...
@push('script')
    <script>
        $().ready(function () {
            ...
            var superUserDataTable =   $('#superUserDataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{route('superadmin.user.super.ajax')}}',
                    type: "POST",
                },
                dom:'Blfrtip',
                lengthMenu: [
            ...
            $("table").on('click', '#ActiveUnactive', function () {
                ...
                $.ajax({
                    url: "{{ route('superadmin.user.statusActiveUnactive') }}",
                    type: "get",
                    ...
                    success: function (res) {
                        if (res === 'true') {
                            ...
                            var superUserDataTable = $('#superUserDataTable').dataTable();
                            superUserDataTable.fnDraw(false);
