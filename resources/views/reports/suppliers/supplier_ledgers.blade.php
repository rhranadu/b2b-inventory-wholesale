...
@section('title', 'Supplier Ledgers Report')
@push('css')
...
{{--                                </div>--}}
                            ...
                            <div class="ajax-data-div table-responsive">
                                <table class="table table-hover table-bordered table-condensed" id="supplier-ledgers-report-table">
                                    <thead>
                                    <tr>
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var supplierLedgersTable =   $('#supplier-ledgers-report-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{route('admin.report.supplier_ledgers.ajax')}}',
                    type: "POST",
                    data: function (d) {
