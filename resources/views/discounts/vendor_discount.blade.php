<div class="card card-custom min-h-200px mb-5">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">Vendor Discount</h3>
        </div>
        ...
        <div class="normal-table-list">
            <div class="bsc-tbl">
                <form method="POST" action="{{ route('admin.discounts.store') }}" id="discount_form" accept-charset="UTF-8"
                    ...
                    @endif
                    <input value="vendors" name="discountable_type" type="hidden">
                    <input name="type_tab" type="hidden" value="vendor">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <select class="form-control select2" id="discountable_id" name="discountable_id">
                                    ...
                                    @foreach($vendors as $vendor)
                                        <option
                                            value="{{ $vendor->id }}" {{ !empty($singleDiscount) && $singleDiscount->discountable_id == $vendor->id ? "selected" : "" }}>{{ $vendor->name }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <tr class="text-nowrap">
                                ...
                                <th style="min-width: 150px" class="text-center">Vendor</th>
                            ...
                            @foreach($discounts as $discount)
                                ...
                                <tr class="text-center align-middle">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a
                                                href="{{ route('admin.discount.vendor') }}"
                                                data-id="{{ $discount->id }}"
