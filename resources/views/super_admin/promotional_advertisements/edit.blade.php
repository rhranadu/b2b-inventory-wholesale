@extends('layouts.app')
@section('title', 'Promotional Ads Edit')
@push('css')
    ...
    <div class="card card-custom min-h-500px" id="kt_card_1">
        <div class="card-body">
            ...
            <div class="normal-table-list">
                <div class="bsc-tbl">
                    <form method="POST" action="{{ route('superadmin.promotional_advertisement.update', $promotionalAdvertisement->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="name" value="{{ $promotionalAdvertisement->name }}" autocomplete="off"
                                   name="name" type="text">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="slug" value="{{ $promotionalAdvertisement->slug }}" autocomplete="off"
                                   name="slug" type="text">
                            @error('slug')
                            <strong class="text-danger" role="alert">
                                <span>{{ $message }}</span>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="link" value="{{ $promotionalAdvertisement->link }}" autocomplete="off"
                                   name="link" type="text">
                            @error('link')
                            <strong class="text-danger" role="alert">
                                <span>{{ $message }}</span>
                        ...
                        <div class="form-group">
                            <label for="position">Position <span
                                    style="color: red; font-size: 20px;"><sup>*</sup></span></label>
                            <input class="form-control" id="position" value="{{ $promotionalAdvertisement->position }}" autocomplete="off"
                        ...
                        <div class="form-group">
                            <div class="checkbox-inline">
                                <label class="checkbox checkbox-outline checkbox-success">
                                    <input
                                        value="1" {{ $promotionalAdvertisement->status == 1 ? 'checked' : '' }} type="checkbox"
...
@push('script')
    ...
    <script>
        $(document).ready(function () {
            filepond_single_image_configure('{{ $promotionalAdvertisement->image_url }}');
