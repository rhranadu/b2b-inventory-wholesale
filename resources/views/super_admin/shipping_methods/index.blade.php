                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">delivery_time</th>
    ...
    <script>
        $().ready(function () {
            ...
            var shippingMethodDataTable =   $('#shippingMethodDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{route('superadmin.shipping_methods.ajax')}}',
                    type: "POST",
                },
                dom:'Blfrtip',
                lengthMenu: [
            ...
            $("table").on('click', '#ActiveUnactive', function () {
                ...
                $.ajax({
                    url: "{{ route('superadmin.shipping_methods.statusActiveUnactive') }}",
                    type: "get",
                    ...
                    success: function (res) {
                        if (res === 'true') {
                            ...
                            toastr.success('Shipping Method status updated success');
                        } else {
