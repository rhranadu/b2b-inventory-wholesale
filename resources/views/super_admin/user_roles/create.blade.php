@extends('layouts.app')
@section('title', 'User Role Create')
        ...
        <div class="card-body">
            ...
            <div class="{{ Session('breadcomb_container') }}">
                ...
                <div class="normal-table-list">
                    <div class="bsc-tbl">
                        <form method="POST" action="{{ route('superadmin.user_role.store') }}" accept-charset="UTF-8"
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_type_id" class="form-control">
                                    ...
                                    @foreach($user_types as $user_type)
                                        <option value="{{ $user_type->id }}">{{ $user_type->table_name }}</option>
                                    @endforeach
                                </select>
                                @error('user_type_id')
                                <strong class="text-danger" role="alert">
