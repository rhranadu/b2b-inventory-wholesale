    ...
    <div class="card card-custom min-h-500px" id="kt_card_1">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">View Sale Payment <i class="mr-2"></i><small>View Sale Payment
                        vendor</small></h3>
            </div>
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($sale->saleDetails as $item)
                                            <tr>
                                                ...
                                                <td class="left">{{ $item->warehouse->name }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="" class="text-right">{{ $sale->sub_total }}</th>
                                        </tr>
                                        <tr>
                                            <th colspan="6" class="text-right">Tax (%)</th>
                                            <th colspan="" class="text-right">{{ $sale->tax }}</th>
                                        </tr>
                                        <tr>
                                            <th colspan="6" class="text-right">Shipping Charge</th>
                                            <th colspan="" class="text-right">{{ $sale->shipping_charge }}</th>
                                        </tr>
                                        <tr>
                                            <th colspan="6" class="text-right"> Discount</th>
                                            <th colspan="" class="text-right">{{ $sale->discount }}</th>
                                        </tr>
                                        <tr>
