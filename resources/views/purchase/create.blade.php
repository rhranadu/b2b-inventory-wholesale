            ...
            <div class="card card-custom min-h-500px" id="kt_card_1">
                <div class="card-body">
                    ...
                    <div class="normal-table-list">
                        <div class="bsc-tbl">
                            <form method="POST" action="{{ route('admin.purchase.store') }}" accept-charset="UTF-8">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        @error('supplier_id')<strong class="text-danger"
                                                                   role="alert"><span>{{ $message }}</span></strong>@enderror
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input required name="date" data-date="" data-date-format="DD MMMM YYYY"
                                                   onchange="ChangeDateFormat(this)" type="date" class="form-control"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="invoice_no"
                                                       value="{{ substr(strtoupper(Auth::user()->vendor->name ), 0, 2) .'-' . rand(0,999999)  }}"
                                                       id="invoice_no" required class="form-control">
                                                <div class="input-group-append autogenerateInvoice"
                                                     style="cursor: pointer">
                                                    <button class="btn btn-primary" type="button">Change Invoice No</button>
                                                </div>
                                            </div>
                                            <p id="checkInvoice"></p>
                                        </div>
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <button type="submit" class="btn"
                                                            style="background: #00c292; color: #f0f0f0">Create
                                                    </button>
                                                </td>
                                            </tr>
                                            </tbody>
        ...
        $(document).ready(function () {
            ...
            $("#addnewItemBtn").click(function (e) {
                ...
                if (attribute_arr_id_solid.length === attribute_arr_map_id_solid.length &&
                    attribute_arr_id_solid.length && qty_arr_solid.length > 0 && price_arr_solid.length > 0 &&
