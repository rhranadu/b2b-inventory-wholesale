            ...
            <div class="card card-custom min-h-500px">
                <div class="card-body">
                    ...
                    <div class="normal-table-list">
                        <div class="bsc-tbl">
                            <form
                                method="POST" action="{{ route('admin.shipping_methods.store') }}" accept-charset="UTF-8"
                                            ...
                                            <div class="bootstrap-select ic-cmp-int">
                                                ...
                                                <select name="vendor_id" id="vendor_id" class="selectpicker form-control" data-live-search="true">
                                                    ...
                                                    @foreach($vendors as $vendor)
                                                        <option value="{{ $vendor->id }}" @if(\Illuminate\Support\Facades\Auth::user()->vendor_id == $vendor->id) selected @else disabled @endif>{{ $vendor->name }}</option>
                                                    @endforeach
                                                </select><br/>
                                                @error('vendor_id')
