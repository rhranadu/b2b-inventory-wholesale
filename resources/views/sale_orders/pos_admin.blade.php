...
@section('main_content')
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Confirmed From</th>
    ...
    <div id="modalBarcode" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-md">
            ...
            <div class="modal-content">
                ...
                <input type="hidden" id="unique_sale_detail_id" class="k-checkbox" value="">
    ...
    <form target="_blank" action="{{ route('admin.sale.order.detail.invoice') }}" id="orderDetailInvoiceForm" method="post">
        @csrf
...
<script>
    $(document).off('click', '#reset_btn').on('click', '#reset_btn', function() {
        ...
        // $("select[name=order_from]").val("").trigger("change");
    ...
    var datatable =   $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{route('admin.sale.order.admin.ajax')}}',
            type: "POST",
            data: function (d) {
    ...
    $(document).off('click', '.invoice').on('click', '.invoice', function (e) {
        $("#orderDetailInvoiceForm").find('input[name="sale_detail_id"]').val($(this).data('id'));
        $("#orderDetailInvoiceForm").submit();
    });
    ...
    function manual_barcode_generate_type() {
        var sale_detail_id = $('#unique_sale_detail_id').val();
        var qty = $('#unique_qty').val();
        $('.appendBarcodeType').html('');
        var setInput = '';
