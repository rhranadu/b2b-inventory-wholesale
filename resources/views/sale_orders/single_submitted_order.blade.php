        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card card-custom min-h-500px" id="kt_card_1">
                    <div class="card-header border-0">
                        <h3 class="card-title font-weight-bolder text-dark">Available Stock</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                ...
                                <tbody>
                                    @foreach($poolStockDetail as $pool)
                                    <tr class="text-center">
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $pool['warehouse']['name'] }}</td>
                                        <td>{{ $pool['warehouse']['type'] }}</td>
                                        <td>{{ !empty($pool['warehouse_detail']) ? $pool['warehouse_detail']['section_name'] : 'N/A' }} </td>
                                        <td>{{ $pool['available_quantity'] }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
