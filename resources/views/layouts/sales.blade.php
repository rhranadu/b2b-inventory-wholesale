...
<html lang="en">
<!--begin::Head-->
@include('component.metronic.head')
...
<div class="d-flex flex-column flex-root h-100">
    ...
    <div class="d-flex flex-row flex-column-fluid page h-100">
        ...
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                                        ...
                                        <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active show" data-toggle="tab"
                                                   href="#topbar_notifications_notifications">Alerts
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab"
                                                   href="#topbar_notifications_events">Events
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300"
                                                ...
                                                <div class="d-flex align-items-center mb-6">
                                                    ...
                                                    <div class="d-flex flex-column font-weight-bold">
                                                        ...
                                                        <span
                                                            class="text-muted">Analytics &amp; Requirement Study
                                                        </span>
                                                    </div>
                                                    <!--end::Text-->
                                                </div>
            ...
            <!--end::Header-->
            <!--begin::Content-->
            <div class="content flex-fill overflow-hidden p-0" id="kt_content">
                <!--begin::Entry-->
                    <!--begin::Container-->
...
@include('component.metronic.toolbar-items')
