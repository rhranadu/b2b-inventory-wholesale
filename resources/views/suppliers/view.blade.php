    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Supplier View</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                <span class="text-muted font-weight-bold mr-4">Supplier view for your company</span>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
            <!--begin::Toolbar-->
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex justify-content-between flex-wrap mt-1">
                                    ...
                                    <div class="my-lg-0 my-3">
                                        <a
                                            href="{{ route('admin.supplier.edit',$data_array->id) }}"
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 pr-8">
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <a class="text-dark-50 text-hover-primary font-weight-bold"
                                               target="_blank"
                                               href="{{ $data_array->website?:'www.website.com' }}">
                                                <i class="flaticon2-website mr-2 font-size-lg"></i>{{ $data_array->website?:'www.website.com' }}</a>
                                        </div>
                                        <div class="font-weight-bold text-dark-50 mb-3">
                                            <span class="text-dark-50 font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                                <i class="la la-bank mr-2 font-size-lg"></i>
                                                {{ isset($supplier->bankAccount->bank_name) ? $supplier->bankAccount->bank_name : old('bank_name') }}
                                            </span>
                                            <span class="text-dark-50 font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                                <i class="la la-bank mr-2 font-size-lg"></i>
                                                {{ isset($supplier->bankAccount->account_name) ? $supplier->bankAccount->account_name : old('account_name') }}
                                            </span>
                                            <span class="text-dark-50 font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                                <i class="la la-bank mr-2 font-size-lg"></i>
                                                {{ isset($supplier->bankAccount->account_number) ? $supplier->bankAccount->account_number : old('account_number') }}
                                            </span>
                                            <span class="text-dark-50 font-weight-bold mr-lg-8">
                                                <i class="la la-bank mr-2 font-size-lg"></i>
                                                {{ isset($supplier->bankAccount->branch) ? $supplier->bankAccount->branch : old('branch') }}
                                            </span>
                                        </div>
                                        <span
