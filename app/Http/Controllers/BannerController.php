...
class BannerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('single_vendor.banner.index',compact('title', 'page_detail'));
    }
        ...
        return DataTables::of($banners)
            ...
            ->addColumn('action', function ($banner) {
                return '<div class="btn-group">
                        <a href="/admin/banner/' . $banner->id . '/edit" class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="auto" title="EDIT" data-original-title="EDIT"><i class="fas fa-pencil-alt"></i></a>
                        ...
                        <form style="display: none" method="POST" id="deleteBannerForm-'.$banner->id.'" action="/admin/banner/'. $banner->id .'">
                        '.csrf_field().'
    ...
    public function create()
    {
        ...
        return view('single_vendor.banner.create',compact('title', 'page_detail'));
    }
    ...
    public function store(BannerStore $request)
    {
        ...
        $slug = Str::slug($request->name, '-');
           ...
           $banner =  Banner::create([
            ...
            return redirect()->action('BannerController@index')->with('success', 'Banner Create Success !');
    ...
    public function edit(Banner $banner)
    {
        ...
        return view('single_vendor.banner.edit', compact('banner','title', 'page_detail'));
    }
...
//                'vendor_id' => Auth::user()->vendor_id,
        ...
        $request['status'] = $request->status ?? 0;
            ...
            return redirect()->action('BannerController@index')->with('success', 'Banner Updated Success !');
