...
class ShippingMethodController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('single_vendor.shipping_methods.index',compact('shipping_methods','title', 'page_detail'));
    }
        ...
        return DataTables::of($shipping_methods)
            ...
            ->addColumn('action', function ($shipping_method) {
                return '<div class="btn-group">
                        <a href="/admin/shipping_methods/' . $shipping_method->id . '/edit" class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="auto" title="EDIT" data-original-title="EDIT"><i class="fas fa-pencil-alt"></i></a>
                        ...
                        <form style="display: none" method="POST" id="deleteShippingMethodForm-'.$shipping_method->id.'" action="/admin/shipping_methods/' . $shipping_method->id . '">
                        '.csrf_field().'
    ...
    public function create()
    {
        ...
        return view('single_vendor.shipping_methods.create',compact('vendors','title', 'page_detail'));
    }
    ...
    public function store(ShippingMethodStore $request)
    {
        ...
        return redirect()->action('ShippingMethodController@index')->with('success', 'Shipping Method Created Success!');
    ...
    public function edit(ShippingMethod $shippingMethod)
    {
        ...
        return view('single_vendor.shipping_methods.edit', compact('shippingMethod', 'vendors','title', 'page_detail'));
    }
    ...
    public function update(ShippingMethodUpdate $request, ShippingMethod $shippingMethod)
    {
        ...
        return redirect()->action('ShippingMethodController@index')->with('success', 'Shipping Method Updated success!');
    }
