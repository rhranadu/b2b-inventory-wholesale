...
class PaymentMethodController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super_admin.payment_methods.index',compact('payment_methods','title', 'page_detail'));
    }
        ...
        return DataTables::of($payment_methods)
            ...
            ->addColumn('action', function ($payment_method) {
                return '<div class="btn-group">
                        <a href="/superadmin/payment_methods/' . $payment_method->id . '/edit" class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="auto" title="EDIT" data-original-title="EDIT"><i class="fas fa-pencil-alt"></i></a>
                        ...
                        <form style="display: none" method="POST" id="deleteShippingMethodForm-'.$payment_method->id.'" action="/superadmin/payment_methods/' . $payment_method->id . '">
                        '.csrf_field().'
    ...
    public function create()
    {
        ...
        return view('super_admin.payment_methods.create',compact('title', 'page_detail'));
    }
    ...
    public function store(PaymentMethodStore $request)
    {
        ...
        return redirect()->action('SuperAdmin\PaymentMethodController@index')->with('success', 'Payment Method Created Success!');
    ...
    public function edit(PaymentMethod $paymentMethod)
    {
        ...
        return view('super_admin.payment_methods.edit', compact('paymentMethod', 'title', 'page_detail'));
    }
    ...
    public function update(PaymentMethodUpdate $request, PaymentMethod $paymentMethod)
    {
        ...
        return redirect()->action('SuperAdmin\PaymentMethodController@index')->with('success', 'Paymnet Method Updated success!');
    }
