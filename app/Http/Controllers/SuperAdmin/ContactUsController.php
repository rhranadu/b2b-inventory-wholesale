...
//        ])->
        ...
        return view('super_admin.contact_us.index',compact('contact_us','title', 'page_detail'));
    }
    ...
    public function create()
    {
        ...
        return view('super_admin.contact_us.create',compact('title', 'page_detail'));
    }
...
//                'super_user_id' => auth()->id(),
        ...
        return redirect()->action('SuperAdmin\ContactUsController@index')->with('success', 'Contact Us successfully add!');
...
//            'super_user_id' => auth()->id(),
        ...
        return view('super_admin.contact_us.edit', compact('contactUs','title', 'page_detail'));
    }
...
//                'super_user_id' => auth()->id()
        ...
        return redirect()->action('SuperAdmin\ContactUsController@index')->with('success', 'Contact Us successfully update!');
