...
//            ])->
        ...
        return view('super_admin.service_contracts.index',compact('service_contracts','title', 'page_detail'));
    }
    ...
    public function create()
    {
        ...
        return view('super_admin.service_contracts.create',compact('title', 'page_detail'));
    }
...
//                'super_user_id' => auth()->id(),
        ...
        return redirect()->action('SuperAdmin\ServiceContractsController@index')->with('success', 'Service Contract successfully add!');
...
//            'super_user_id' => auth()->id(),
        ...
        return view('super_admin.service_contracts.edit', compact('serviceContracts','title', 'page_detail'));
    }
...
//                'super_user_id' => auth()->id()
        ...
        return redirect()->action('SuperAdmin\ServiceContractsController@index')->with('success', 'Service Contract successfully update!');
