...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'CheckSaleRole' => SaleMiddleware::class,
        'CheckOperatorRole' => OperatorMiddleware::class,
        'CheckVendorAdminRole' => VendorAdminMiddleware::class,
        'AdminPanel' => AdminPanelMiddleware::class,
        'CheckAccountRole' => AccountMiddleware::class,
